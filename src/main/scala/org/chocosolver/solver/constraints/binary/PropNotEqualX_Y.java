 ...
 * @since 0.01
 */
public class PropNotEqualX_Y extends Propagator<IntVar> implements java.io.Serializable {
...
//        this.init(ArrayUtils.toArray(this.x, this.y), PropagatorPriority.BINARY, false, false);
//    }
