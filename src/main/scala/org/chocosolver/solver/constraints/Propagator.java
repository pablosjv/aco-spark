 ...
 */
public abstract class Propagator<V extends Variable & java.io.Serializable> implements ICause, Identity, Comparable<Propagator>, java.io.Serializable{
...
//    private final int ID;
     ...
     */
    private boolean swapOnPassivate;
...
//    protected final Model model;
     ...
     */
    public Propagator(V[] vars, PropagatorPriority priority, boolean reactToFineEvt, boolean swapOnPassivate) {
        assert vars != null && vars.length > 0 && vars[0] != null : "wrong variable set in propagator constructor";
        /*Move the constructor to a init function*/
        init(vars, priority, reactToFineEvt, swapOnPassivate);
    }

    public void init(V[] vars, PropagatorPriority priority, boolean reactToFineEvt, boolean swapOnPassivate) {
